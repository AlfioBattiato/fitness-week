        ...
        <>
            ...
            <nav className={` navbar navbar-expand-lg ${location.pathname === '/' ? 'bg-nav' : ''}  ${isScrolled ? 'bg-black' : ''}`}>
                ...
                <div className="container">
                    <Link className="navbar-brand   text-secondary " to="/">CoreCraze</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link  text-secondary d-flex align-items-center gap-1" href="#footer "> <MdOutlineContactSupport />Contact</a>
                            </li>
                            {user?.role === 'guest' && (
                                <li className="nav-item">
...
Your courses</Link>
                        ...
                        {user ? (
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <div className="d-flex px-2 align-items-center">
                                            <IoIosSettings />
                                            <li><Link className="dropdown-item border-0 ps-1  " to={`/dashbord/${user.id}`}>Profile</Link></li>

                                        </div>
                                        <div className="d-flex px-2 align-items-center">
                                            <RiLogoutBoxLine />
                                            <li><Link onClick={logout} className="dropdown-item border-0 ps-1">Logout</Link></li>
                                        </div>
                            ...
                            <button className='btn btn-light rounded-0 ms-2 ' onClick={() => navigate('/Login')}>Login</button>
